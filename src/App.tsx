...
import { Mic, Send, Play, X, Film, ChevronLeft, ChevronRight, Sparkles } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#020408] text-white font-sans selection:bg-orange-500 selection:text-black overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute top-[-20%] left-[-10%] w-[80%] h-[80%] bg-[#4d2e1a] blur-[180px] rounded-full opacity-30" 
        />
        <motion.div 
          animate={{ 
            scale: [1.2, 1, 1.2],
          ...
          className="absolute bottom-[-10%] right-[-10%] w-[70%] h-[70%] bg-[#4d3c1a] blur-[180px] rounded-full opacity-20" 
        />
        <motion.div 
          animate={{ 
            opacity: [0.1, 0.3, 0.1],
          ...
          className="absolute top-[30%] right-[10%] w-[50%] h-[50%] bg-[#4d2e1a] blur-[150px] rounded-full opacity-15" 
        />
            ...
            >
              <div className="space-y-4">
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-xs font-mono uppercase tracking-[0.3em] text-orange-400"
                >
                ...
                <h1 className="text-5xl md:text-8xl font-black tracking-tight uppercase leading-tight italic font-display px-10 overflow-visible">
                  Cine<span className="text-transparent bg-clip-text bg-gradient-to-br from-orange-400 via-yellow-500 to-red-600 pr-3">Mood </span>
                </h1>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-yellow-500 translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-500" />
              </motion.button>
            </motion.div>
          )}
              ...
              <form onSubmit={handleSubmitMood} className="space-y-8">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    type="submit"
                    disabled={!mood.trim()}
                    className="px-16 py-5 bg-orange-500 text-black font-black uppercase tracking-tighter hover:bg-white transition-all disabled:opacity-20 disabled:cursor-not-allowed shadow-[0_0_40px_rgba(249,115,22,0.3)]"
                  >
                    Genera Visione
                  </button>
                </div>
            ...
            >
              <div className="relative w-32 h-32">
                <motion.div
                  ...
                  className="absolute inset-0 border-2 border-orange-500/30"
                />
                <motion.div
                  animate={{ 
                    scale: [1.2, 1, 1.2],
          ...
          {state === 'result' && (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-12">
                <div className="space-y-4">
                  <h2 className="text-5xl md:text-8xl font-black tracking-tight uppercase italic leading-tight font-display px-6">Film <span className="text-orange-500">Consigliati</span></h2>
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    ...
                    className="px-8 py-4 border border-orange-500/30 text-orange-500 rounded-full hover:bg-orange-500 hover:text-black transition-all font-bold uppercase tracking-widest text-xs backdrop-blur-md"
                  >
                    Riavvia Ricerca
                  </button>
                  <button
      ...
      <div className="space-y-8 max-w-4xl">
        ...
        >
          ...
          <div className="flex items-center gap-6">
            <h3 className="text-4xl md:text-6xl font-black tracking-tight uppercase italic leading-tight font-display px-6 overflow-visible group-hover:text-orange-500 transition-colors">
              {movie.title}
            </h3>
            <motion.div
              ...
              <div className="pt-8 space-y-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-zinc-500 text-lg font-light leading-relaxed italic border-l-2 border-orange-500/20 pl-8 py-2">
                      "{movie.reason}"
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                  ...
                  <div className="lg:col-span-8 space-y-12">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-4 bg-white text-black py-6 font-black uppercase tracking-widest text-sm hover:bg-orange-500 transition-all group shadow-[0_20px_40px_-10px_rgba(255,255,255,0.1)] rounded-2xl"
                    >
                              ...
                              <div className="flex gap-1">
                                {[...Array(5)].map((_, starIndex) => (
                                  <Sparkles
                                    ...
                                    size={12}
                                    className={cn(
                                      starIndex < Math.floor(rating.score) ? "text-orange-500 fill-orange-500" : "text-zinc-800"
                                    )}
                                  />
                                ))}
                              </div>
                            </div>
                            <span className="text-2xl font-black font-display italic text-orange-500">{rating.score}</span>
                          </div>
                        ))}
                      </div>
                    </div>
